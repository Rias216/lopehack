...
namespace render {
	...
	void draw_filled_rect_up(int x, int y, int w, int h, color color);
	void draw_gradient_rect_vertical(int x, int y, int w, int h, color c_color, color color1);
	...
	namespace fonts {
		...
		extern unsigned long font_smallest7;
		extern unsigned long visitor;
		extern unsigned long pokemon;
		extern unsigned long porter;
	}
